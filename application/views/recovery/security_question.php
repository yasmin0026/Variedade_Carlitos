...
<body style="background-color: #E4E9F7">
	...
	$recovery_pregunta = base64_decode($datos->RECOVERY_PREGUNTA);
	$recovery_respuesta = base64_decode($datos->RECOVERY_RESPUESTA);
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				<form action="<?=base_url().'RecoveryController/SecurityFinal';?>" method="post">
					<input type="hidden" name="id" value="<?=$id;?>">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">Pregunta de seguridad</h4>
						</div>
						<div class="card-body">
							...
							<div class="col-md-12">
								...
								<input type="text" name="pregunta" class="form-control" value="<?=$recovery_pregunta;?>" readonly>
							</div>
							<div class="col-md-12">
								<label>Respuesta: </label>
								<input type="text" name="respuesta" class="form-control" placeholder="Ingresa tu" required>
							</div>
						</div>
